...
export function PDFs() {
  ...
  const pdfs = products.filter(p => p.category === 'pdf');
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">PDFs</h1>
        <p className="text-gray-600 text-lg">
          Découvrez notre collection de PDFs éducatifs et professionnels
        </p>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Rechercher des PDFs..."
                value={searchTerm}
      ...
      <div className="mb-4">
        <p className="text-gray-600">
          {filteredPDFs.length} PDF{filteredPDFs.length > 1 ? 's' : ''} trouvé{filteredPDFs.length > 1 ? 's' : ''}
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          <p className="text-gray-500 text-lg">Aucun PDF trouvé</p>
